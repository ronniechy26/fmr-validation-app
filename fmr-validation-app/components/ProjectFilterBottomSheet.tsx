...
interface ProjectFilterBottomSheetProps {
  ...
  onApply: (keyFilter: KeyFilter, regionFilter: RegionFilter) => void;
  snapPoints: string[];
...
export const ProjectFilterBottomSheet = forwardRef(function ProjectFilterSheet(
  {
    activeKeyFilter,
    activeRegionFilter,
    onApply,
  ...
  }, [activeKeyFilter, activeRegionFilter]);
  ...
  const handleApply = () => {
    setIsLoading(true);
    setTimeout(() => {
      onApply(selectedKeyFilter, selectedRegion);
      setIsLoading(false);
      close();
    }, 500);
  };
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <View style={styles.headerText}>
              <Text style={[styles.title, { color: colors.textPrimary }]}>Filter Projects</Text>
              <Text style={[styles.subtitle, { color: colors.textMuted }]}>
                Filter by project attributes and location
              </Text>
            </View>
          </View>
          <TouchableOpacity
